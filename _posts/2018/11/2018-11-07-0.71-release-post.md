...
Rocket.Chat is proud to announce a new release of
...
For a full list of features added and bugs fixed, please see the [Rocket.Chat 0.71 release changelog on GitHub](https://github.com/RocketChat/releases/tag/v0.71.0).
